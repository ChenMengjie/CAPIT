sCCA_swap_precision_cross <- function(X, Y, search.grid = seq(0.5, 3, by=0.5), preX1, preY1, preX2, preY2){
  ...
  XY1 <- sCCA_precision_cross_validation(X1, Y1, X2, Y2, search.grid, preX1, preY1)
  XY2 <- sCCA_precision_cross_validation(X2, Y2, X1, Y1, search.grid, preX2, preY2)
